    ...
    return Obx(() => _DetailContainer(
      children: [
        _DetailRow(
          ...
          onTap: () => controller.onPersonalDetailTap('weight'),
        ),
        _Divider(),
        _DetailRow(
          ...
          onTap: () => controller.onPersonalDetailTap('height'),
        ),
        _Divider(),
        _DetailRow(
          ...
          onTap: () => controller.onPersonalDetailTap('age'),
        ),
        _Divider(),
        _DetailRow(
          ...
          onTap: () => controller.onPersonalDetailTap('goal'),
        ),
        _Divider(),
        _DetailRow(
          ...
          onTap: () => controller.onPersonalDetailTap('diet'),
          isLast: true,
        ),
      ],
    ));
    ...
    return _DetailContainer(
      children: [
        _DetailRow(
          ...
          label: 'Support & Legal',
          onTap: controller.onSupportAndLegal,
        ),
        _Divider(),
        _DetailRow(
