...
class DietOption {
  ...
  const DietOption({required this.emoji, required this.label});
}
...
class EditDietController extends GetxController {
  ...
  final List<DietOption> diets = const [
    ...
    DietOption(emoji: '🥦', label: 'Vegetarian'),
    DietOption(emoji: '🌱', label: 'Vegan'),
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  final option = controller.diets[index];
                  return Obx(() => _SelectionCard(
                    emoji: option.emoji,
                    label: option.label,
                    isSelected: controller.selectedDiet.value == option.label,
                    onTap: () => controller.selectDiet(option.label),
                  ));
                },
              ),
            ),
